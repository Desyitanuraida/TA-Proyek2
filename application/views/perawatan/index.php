    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= base_url('admin/perawatan/form') ?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value) : ?>
                            <tr>
                                ...
                                <td><?= $value->tanggal ?></td>
                                <td><?= $value->nopol ?></td>
                                <td><?= $value->jenis_perawatan ?></td>
                                <td><?= $value->biaya ?></td>
                                <td class="text-center">
                                    <a href="<?= base_url('admin/perawatan/form/'.$value->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                    <a href="<?= base_url('admin/perawatan/delete/'.$value->id) ?>" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-danger"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
